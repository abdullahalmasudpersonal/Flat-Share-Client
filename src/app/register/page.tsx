        ...
        <Box component="form" noValidate sx={{ mt: 3 }}>
          ...
          >
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <Input name="name" required fullWidth label="Name" />
              </Grid>
              <Grid item xs={12}>
                <Input required fullWidth label="Username" name="username" />
              </Grid>
              <Grid item xs={12}>
                <Input required fullWidth label="Email Address" name="email" />
              </Grid>
              <Grid item xs={12}>
                <Input
                  required
