...
import { Box, Button, Container, Grid, Paper, Stack, styled, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from "@mui/material";
...
const AdminFlatDetailPage = ({ params }: TParams) => {
    ...
    console.log(flatDetail?.flatName);

    return (
        <>
            <Box >
                <Typography textAlign='center' variant='h5' mb={3} color='purple' fontWeight='600' fontFamily='shorif'>Flat Details</Typography>
            </Box>
                    ...
                    <Grid xs={12} md={8} padding="16px">
                        <Stack direction={{ xs: "column", md: "row" }} gap={2} flexWrap={"wrap"}>
                            ...
                            <StyledInformationBox>
                                ...
                                <Typography>{flatDetail?.availability ? (
                                    <>
                                        {"Yes"}&nbsp;
                                        <CheckCircleIcon
                                            fontSize="small"
                ...
                {/*   <TableCell align="right">{flatDetail?.rent}</TableCell>
                 ...
                 {/*  <TableCell align="right">{flatDetail?.location}</TableCell> */}
                  ...
                  <TableCell align="center">
                      <Link href={`/dashboard/admin/flat-management/${flatDetail?.id}`}> 
